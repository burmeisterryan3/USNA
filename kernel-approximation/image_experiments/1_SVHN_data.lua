...
train_filename = 'train_32x32.t7'
test_filename = 'test_32x32.t7'
extra_filename = 'extra_32x32.t7'
data_path = 'data/SVHN/'
train_file = data_path .. train_filename
test_file = data_path .. test_filename
extra_file = data_path .. extra_filename

if not paths.filep(train_file) then
   os.execute('wget -P ' .. data_path .. ' ' .. www .. train_filename)
end
if not paths.filep(test_file) then
   os.execute('wget -P ' .. data_path .. ' ' .. www .. test_filename)
end
if opt.size == 'extra' and not paths.filep(extra_file) then
   os.execute('wget -P ' .. data_path .. ' ' .. www .. extra_filename)   
end
